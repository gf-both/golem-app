...
const B = {
  name: 'KAREN YANINA SZKLIARSKI',
  day: 23, month: 11, year: 1977,
  hour: 6, minute: 30,
...
safe('hd', () => { const c = computeHDChart({ dateOfBirth: '1977-11-23', timeOfBirth: '06:30', utcOffset: -3 }); try { c.tags = buildHDTags(c) } catch {} ; return c })
